...
void setup()
{
  ...
  {  
    ...
    Serial.print(magCalibration[0]); Serial.print(","); Serial.print(magCalibration[1]); Serial.print(","); Serial.println(magCalibration[2]);    
    delay(1000);
    //magcalMPU9250(magbias, magscale);
    Serial.println("AK8963 mag biases (mG)"); 
    Serial.println(magbias[0]); Serial.println(magbias[1]); Serial.println(magbias[2]);
    magscale[0] = 0.80;
    magscale[1] = 1.56;
    magscale[2] = 0.90;
    Serial.print(magscale[0]); Serial.print(","); Serial.print(magscale[1]); Serial.print(","); Serial.println(magscale[2]);    
    delay(2000);
